    ...
    public class DrawOptionsView : MonoBehaviour {
        ...
        public void SetParticipantInfoSelected(bool[] infoSelected) {
            if (infoSelected.Length != allInfoCheckmarks.Count) {
                Debug.LogError("SetParticipantInfoSelected: Wrong info selected array size: " + infoSelected.Length);
                return;
            }
        ...
        public void ResetDrawOptions() {
            ...
            SetParticipantInfoSelected(new bool[Enum.GetValues(typeof(ParticipantBasicInfo)).Length]);
        }
    }
}
